...
import { User, MoveRight, Circle } from "lucide-react";
...
export const PlayerInfo: React.FC<PlayerInfoProps> = ({
  ...
  <div className="w-full inline-flex items-center gap-4 p-2 bg-neutral-900">
    ...
    {/* Move button to the far right with ml-auto */}
    {isCurrentPlayer && (
      <button
        title="End Turn"
        className="ml-auto transition-all duration-500 bg-primary hover:brightness-110 disabled:bg-blue-400 
                   text-text font-medium py-2 px-4 rounded"
      >
        <MoveRight />
      </button>
    )}
